 ...
 */
public class GenovesaPizza extends Pizza {

    BaseToppingAbstractFactory toppingFactory;
    public GenovesaPizza(BaseToppingAbstractFactory toppingFactory){
        this.toppingFactory=toppingFactory;
    }

    @Override
    public void addIngredients() {
        System.out.println("Preparing ingredients for genovesa pizza.");
